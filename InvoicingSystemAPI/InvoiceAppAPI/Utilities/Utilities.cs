//@Plik jest pobrany ze strony http://dev.cdur.pl/Artykuly/Zamiana-kwoty-liczbowej-na-kwote-slowna-w-CSNET

using System.Collections.Generic;
using System.Text;

namespace InvoiceAppAPI.Utilities
{
  public class ValueToWords
  {
    ...
    public static string NumberToValue(int liczba)
    {
      return NumberToValueBase(liczba).Replace("  ", " ").Trim();
    }
    public static string FitCurrencyName(int liczba, string kodWaluty)
    {
      var key = Waluty[kodWaluty];
      return key[DeklinacjaWalutyIndex(liczba)];
    }

    private static string NumberToValueBase(int wartosc)
    {
