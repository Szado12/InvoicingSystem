...
export const InvoiceRowWizard = (prop:{invoiceRow:InvoiceRow,index:number, list:string}) => {
				...
				<Col xs={23}>
					<Row className={'InvoicePositionCardRow'}> 
						<Col xs={8} className={'InvoicePositionCardRowTypeahead'}>
							<GenericTypeahead onChange={SetProduct} selected={prop.invoiceRow.product} url={'https://localhost:44325/api/products?list='+prop.list} type={'product'}/>
						</Col>
						<Col xs={2}>
							<input
